...
## Vertical-specific Cashfree hooks for SaaS
...
| Working capital for India-HQ'd SaaS | Capital | Pre-approved line based on Cashfree transaction history |
...
This is the smallest persona vertical for v1. Most Indian SaaS use Stripe globally + a domestic gateway for INR billing — Cashfree's sweet spot is the AutoPay + International PG combo. Will expand to founder-saas + cto-saas + head-of-customer-success once v1 deals validate the wedge.
