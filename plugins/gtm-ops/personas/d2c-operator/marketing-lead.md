...
common_companies: ["D2C Series A+ brands", "Subscription brands", "Personal care / beauty / wellness", "Food / nutrition", "Apparel / lifestyle"]
typical_stage: ["Series A → Series C", "₹20 Cr → ₹300 Cr GMV"]
...
# Marketing Lead / CMO — D2C

## 1. Identity

The brand + marketing leader at a Series A+ D2C brand. 8-15 years experience, often FMCG (HUL / P&G / Britannia) or agency (Ogilvy / Wieden) background, increasingly ex-Cred/Swiggy/Razorpay marketing alumni. Reports to Founder/CEO. Owns brand, content, performance marketing budget allocation, influencer partnerships, customer experience, and retention storytelling. Lives in Excel + brand-tracker dashboards + Meta/Google ad managers + influencer-platform tools.

**Where you find them:** Goafest, Indian Marketing Conclave, Zee Digital ad summits, Cannes Lions India panels, Storyboard18 events, Superhuman of Marketing newsletter, Adgully events, ET BrandEquity events. Very active on LinkedIn — posts weekly on brand campaigns + marketing wins.

**Where they don't hang:** RBI / fintech / dev events; finance / treasury forums; ops-supply-chain meetups.
...
- Loyalty program payout (cashback / rewards) operational drag
- Trade marketing (offline channel partner) payments
- ROI attribution across performance + brand
- Multi-currency creator payments for international expansion
- Brand-experience consistency across payment touchpoints
...
- Subscription adoption (if applicable)
...
1. **Brand-protective checkout (success rate + UX)** (30%)
2. **Subscription enablement quality (AutoPay UX)** (25%)
3. **Influencer payout speed + creator NPS impact** (20%)
4. **Storytelling + co-marketing potential (peer-brand stories)** (10%)
...
- Generic "we improve checkout"
- ROI-calculator with 8 inputs
- Pricing-led pitch
- Long emails
- Webinar invites (unless they're speaking)
- B2B-style cold sales tactics
...
### When THIS persona IS the champion (rarely buyer)

- Subscription-launch decisions (CMO + Founder co-decide)
- Loyalty program infrastructure
- Influencer-payment operations
- Co-marketing partnerships
- Brand-protective vendor decisions
- **Pattern:** CMO almost always champions but rarely signs; deals routes through CFO + Founder

### When this persona is NOT the buyer (still influences)

- All operational vendor decisions (Head of Ops or CFO own)
- Capital / financing (CFO + Founder)
- International expansion stack (Founder + CFO)
- **Pattern:** CMO is brand + storytelling champion; arm them with case studies + peer-CMO intros + co-marketing offers
...
| Loyalty program | "Saw {brand}'s loyalty signup numbers — usually means cashback/rewards payout ops growing. Payouts API for instant cashback + auto-recon to your loyalty CRM." |
...
- ❌ Engineering-heavy framing
- ❌ "Schedule a demo" without brand framing
- ❌ ROI calculator
- ❌ Pricing-led pitch
- ❌ Long unstructured emails
- ❌ Generic "we improve marketing"
- ❌ B2B-style sales cadence
...
|---|---|---|
| LinkedIn DM (peer-CMO reference + co-marketing angle) | First touch | 1-2 messages, 5d apart |
...
- `Madhu Gopinath @ Sleepy Owl Coffee — Head of Marketing`
