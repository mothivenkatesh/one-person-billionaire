...
spear_products: [payments-core, autopay]
common_titles:
  - "Head of Growth"
  - "VP Growth"
  - "Director - Growth"
  ...
  - "Head of D2C / Online"
  - "Head of E-commerce"
common_companies: ["D2C Series A+ brands", "Subscription brands (Wow / Plum / Sleepy Owl)", "Quick-commerce", "OTT/SaaS-hybrids", "Online-first beauty/health"]
typical_stage: ["Series A → Series C", "₹20 Cr → ₹500 Cr GMV"]
...
The growth-marketing + funnel-optimization leader at a Series A+ D2C brand. 6-12 years experience, usually performance-marketing background (Meta / Google ads + Shopify funnels), often ex-CRED / Swiggy / Zomato growth alumni. Reports to Founder/CEO or CMO. Owns CAC, conversion rate, AOV, LTV, retention loops, and the checkout funnel. Lives in GA4 + Shopify + Mixpanel + Excel + Meta Ads Manager. Knows every percentage point of conversion at each funnel step.

**Where you find them:** Mixpanel India, GrowthHackers India, Inc42 D2C summits, MoEngage Growth Summit, GrowthStory podcast guests, Headstart growth meetups, Superhuman of D2C newsletter readers. Very active on LinkedIn — posts weekly on growth experiments + benchmarks.

**Where they don't hang:** RBI / fintech events, dev communities, finance forums.
...
- Retention loops (subscription model adoption rate)
- Cohort LTV (vs CAC payback)
- Multi-payment-method conversion (cards vs UPI vs Pay Later vs cash)
- COD-vs-prepaid mix optimization
- Wallet / Pay Later integration (Simpl, LazyPay, Paytm Postpaid)
...
- Checkout completion rate (cart → paid)
- AOV (avg order value)
- CAC payback period
- LTV / CAC ratio
- Repeat purchase rate
- Subscription adoption rate (if applicable)
...
1. **Checkout-success-rate uplift (proven via A/B test on their traffic)** (40%) — the only metric that matters
2. **AutoPay coverage + mandate UX** (20%) — for subscription brands
3. **Integration time (Shopify Plus / WooCommerce / custom)** (15%)
4. **Reporting + analytics depth (funnel-step view)** (10%)
...
- Reporting is high-level, not funnel-step
...
- Generic "we're better"
- "Schedule a demo" without A/B offer
- Marketing speak
- Long emails
- Pitching to them on MDR/pricing (they'll route to CFO)
- Webinar invites (unless growth-specific)
...
### When THIS persona IS the buyer (or primary champion)

- Checkout-vendor decisions (growth-lead drives + decides up to ₹X)
- AutoPay / subscription billing infrastructure
- Pay-Later / wallet integrations
- Conversion-rate-optimization tooling
- A/B testing infrastructure
- **Pattern:** growth-lead drives evaluation + champions internally; CFO signs contract

### When this persona is NOT the buyer (still primary champion)

- Strategic vendor consolidation (Founder + CFO)
- International PG (Founder + CFO)
- Capital (CFO + Founder)
- Compliance / risk (Head of Risk where applicable)
- **Pattern:** growth-lead almost always champions; arm them with A/B data + peer-growth-lead references
...
- ❌ No specific uplift number
- ❌ Pitching strategic / brand framing (they want growth metrics)
...
|---|---|---|
| LinkedIn DM (peer growth-lead reference) | First touch | 1-2 messages, 5d apart |
| Cold email (A/B offer + uplift number) | First or second touch | 2 emails 4d apart |
| Phone | After 1 reply | Scheduled |
| Twitter/X DM | If they're publicly active | Rare; high signal |
| Slack (growth communities) | Conversation-based | As relevant |
| In-person | Inc42 / GrowthStory / MoEngage events | Quarterly+ |

**Volume cap:** 5 touches per quarter; growth-leads are responsive to A/B-test offers.
...
- `Anuj Rathi @ Swiggy — VP Growth (D2C cross-pollination)`
