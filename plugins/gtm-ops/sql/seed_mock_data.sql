-- seed_mock_data.sql — realistic mothi-flavored sample data so marts populate end-to-end.
...
('priya.sharma@mothi.com', 'Priya Sharma', '{A,B}', '{bfsi}', 50000000, 30, '2023-08-01'),
('rahul.kumar@mothi.com', 'Rahul Kumar', '{A,B}', '{bfsi}', 45000000, 30, '2024-01-15'),
('anjali.mehta@mothi.com', 'Anjali Mehta', '{A,B}', '{d2c}', 40000000, 30, '2023-11-01'),
('vikram.singh@mothi.com', 'Vikram Singh', '{B,C}', '{d2c,marketplace}', 30000000, 30, '2024-03-15'),
('aditi.rao@mothi.com', 'Aditi Rao', '{A,B}', '{saas}', 42000000, 30, '2023-06-01'),
('rohan.gupta@mothi.com', 'Rohan Gupta', '{B,C}', '{saas,marketplace}', 28000000, 30, '2024-05-01'),
('sneha.patel@mothi.com', 'Sneha Patel', '{C}', '{d2c,saas}', 18000000, 30, '2024-09-01')
...
('AGS-GTM-20260301-001', 'BFSI Tier-A Mobile360 Q2 push',         'acquisition',    'A', 'bfsi',        '{linkedin_inmail,cold_email}', 'https://docs.google.com/d/example1', 'mothi@mothi.com', '{vp.marketing@mothi.com,compliance@mothi.com}', 'live',     now() - interval '50 days', '{vp.marketing@mothi.com,compliance@mothi.com}', now() - interval '49 days', 'mothi_warmed', 'inmail', 250000,  300000, true, true, true, true, true, true),
('AGS-GTM-20260305-002', 'D2C MamaEarth-style cohort outbound',   'acquisition',    'B', 'd2c',         '{cold_email,linkedin_inmail}', 'https://docs.google.com/d/example2', 'mothi@mothi.com', '{vp.marketing@mothi.com}',                          'live',     now() - interval '45 days', '{vp.marketing@mothi.com}',                          now() - interval '44 days', 'mothiteam',     'email',  180000,  200000, true, true, true, true, true, true),
('AGS-GTM-20260310-003', 'SaaS subscription AutoPay nurture',     'nurture',        'B', 'saas',        '{moengage_lifecycle,cold_email}','https://docs.google.com/d/example3', 'mothi@mothi.com', '{vp.marketing@mothi.com}',                          'live',     now() - interval '40 days', '{vp.marketing@mothi.com}',                          now() - interval '39 days', 'moengage',         'email',  120000,  150000, true, true, true, true, true, true),
('AGS-GTM-20260315-004', 'BFSI lender Mobile360 cross-sell',      'cross-sell',     'B', 'bfsi',        '{moengage_lifecycle,csm_outreach}','https://docs.google.com/d/example4', 'cs@mothi.com',     '{vp.cs@mothi.com}',                                'live',     now() - interval '35 days', '{vp.cs@mothi.com}',                                  now() - interval '34 days', 'moengage',         'email',  80000,   100000, true, true, true, true, true, true),
('AGS-GTM-20260320-005', 'D2C Payments→Payouts cross-sell pilot', 'cross-sell',     'B', 'd2c',         '{moengage_lifecycle,in_app}',  'https://docs.google.com/d/example5', 'cs@mothi.com',     '{vp.cs@mothi.com}',                                'live',     now() - interval '30 days', '{vp.cs@mothi.com}',                                  now() - interval '29 days', 'moengage',         'in_app', 50000,   75000,  true, true, true, true, true, true),
('AGS-GTM-20260325-006', 'Marketplace Tier-A Swiggy-pattern push','acquisition',    'A', 'marketplace', '{linkedin_inmail,partner}',    'https://docs.google.com/d/example6', 'mothi@mothi.com', '{vp.marketing@mothi.com,founders@mothi.com}',   'live',     now() - interval '25 days', '{vp.marketing@mothi.com,founders@mothi.com}',     now() - interval '24 days', 'mothi_warmed', 'inmail', 350000,  400000, true, true, true, true, true, true),
('AGS-GTM-20260401-007', 'BFSI dormant re-engagement Q1 cohort',  're-engagement',  'B', 'bfsi',        '{cold_email,moengage_lifecycle}','https://docs.google.com/d/example7', 'mothi@mothi.com', '{vp.marketing@mothi.com}',                          'live',     now() - interval '20 days', '{vp.marketing@mothi.com}',                          now() - interval '19 days', 'mothiteam',     'email',  90000,   100000, true, true, true, true, true, true),
('AGS-GTM-20260405-008', 'D2C SMB churn-save WhatsApp campaign',  'churn-save',     'C', 'd2c',         '{whatsapp,moengage_lifecycle}','https://docs.google.com/d/example8', 'cs@mothi.com',     '{vp.cs@mothi.com,compliance@mothi.com}',         'live',     now() - interval '17 days', '{vp.cs@mothi.com,compliance@mothi.com}',          now() - interval '16 days', 'moengage',         'whatsapp', 30000, 50000, true, true, true, true, true, true),
('AGS-GTM-20260410-009', 'WTFraud Q2 webinar drive',              'acquisition',    'B', 'bfsi',        '{wtfraud_community,linkedin_ads}','https://docs.google.com/d/example9', 'mothi@mothi.com', '{vp.marketing@mothi.com}',                          'live',     now() - interval '12 days', '{vp.marketing@mothi.com}',                          now() - interval '11 days', 'wtfraud',          'community',60000, 80000,  true, true, true, true, true, true),
('AGS-GTM-20260415-010', 'SaaS expansion Capital cross-sell',     'cross-sell',     'B', 'saas',        '{moengage_lifecycle,csm_outreach}','https://docs.google.com/d/example10','cs@mothi.com',     '{vp.cs@mothi.com}',                                'in_review',NULL,                       NULL,                                                    NULL,                       'moengage',         'email',  0,       100000, true, true, true, false, false, false),
('AGS-GTM-20260420-011', 'Q3 Marketplace Cars24-pattern outbound','acquisition',    'B', 'marketplace', '{cold_email,linkedin_inmail}', 'https://docs.google.com/d/example11','mothi@mothi.com', '{vp.marketing@mothi.com}',                          'draft',    NULL,                       NULL,                                                    NULL,                       'mothiteam',     'email',  0,       150000, true, false, false, false, false, false),
('AGS-GTM-20260425-012', 'D2C International PG nurture (UAE)',    'nurture',        'B', 'd2c',         '{moengage_lifecycle,linkedin_inmail}','https://docs.google.com/d/example12','mothi@mothi.com','{vp.marketing@mothi.com}',                       'live',     now() - interval '2 days',  '{vp.marketing@mothi.com}',                          now() - interval '1 day',   'moengage',         'email',  20000,   100000, true, true, true, true, true, true)
...
-- Closed-won (12 deals)
('deal_001', 'acc_007', 'closed_won', 8500000,  'priya.sharma@mothi.com', now() - interval '2 days',   'demand_gen', 'cold_email',     'AGS-GTM-20260301-001', now() - interval '95 days', now() - interval '90 days', now() - interval '85 days', now() - interval '85 days', now() - interval '80 days', now() - interval '70 days', now() - interval '50 days', 'new_business', now() - interval '5 days',  NULL,                          NULL, now() - interval '95 days'),
('deal_002', 'acc_014', 'closed_won', 4200000,  'anjali.mehta@mothi.com', now() - interval '8 days',   'demand_gen', 'linkedin_inmail','AGS-GTM-20260305-002', now() - interval '70 days', now() - interval '65 days', now() - interval '60 days', now() - interval '60 days', now() - interval '55 days', now() - interval '40 days', now() - interval '25 days', 'new_business', now() - interval '10 days', NULL,                          NULL, now() - interval '70 days'),
('deal_003', 'acc_023', 'closed_won', 2800000,  'anjali.mehta@mothi.com', now() - interval '12 days',  'demand_gen', 'webinar',        'AGS-GTM-20260305-002', now() - interval '60 days', now() - interval '55 days', now() - interval '52 days', now() - interval '52 days', now() - interval '48 days', now() - interval '35 days', now() - interval '20 days', 'new_business', now() - interval '14 days', NULL,                          NULL, now() - interval '60 days'),
('deal_004', 'acc_034', 'closed_won', 3500000,  'aditi.rao@mothi.com',    now() - interval '6 days',   'inbound',    'content_inbound',NULL,                  now() - interval '50 days', now() - interval '47 days', now() - interval '45 days', now() - interval '45 days', now() - interval '40 days', now() - interval '30 days', now() - interval '15 days', 'new_business', now() - interval '8 days',  NULL,                          NULL, now() - interval '50 days'),
('deal_005', 'acc_044', 'closed_won', 6800000,  'rohan.gupta@mothi.com',  now() - interval '15 days',  'partner',    'partner',        NULL,                  now() - interval '120 days',now() - interval '115 days',now() - interval '110 days',now() - interval '110 days',now() - interval '105 days',now() - interval '90 days', now() - interval '60 days', 'new_business', now() - interval '17 days', NULL,                          NULL, now() - interval '120 days'),
('deal_006', 'acc_011', 'closed_won', 1800000,  'rahul.kumar@mothi.com',  now() - interval '20 days',  'demand_gen', 'webinar',        'AGS-GTM-20260410-009', now() - interval '55 days', now() - interval '50 days', now() - interval '48 days', now() - interval '48 days', now() - interval '42 days', now() - interval '32 days', now() - interval '22 days', 'new_business', now() - interval '22 days', NULL,                          NULL, now() - interval '55 days'),
-- Closed-won expansion (cross-sell)
('deal_007', 'acc_007', 'closed_won', 1200000,  'priya.sharma@mothi.com', now() - interval '3 days',   'cross_sell', 'csm_outreach',   'AGS-GTM-20260315-004', now() - interval '40 days', now() - interval '38 days', now() - interval '35 days', now() - interval '35 days', now() - interval '32 days', now() - interval '25 days', now() - interval '15 days', 'expansion',    now() - interval '5 days',  NULL,                          NULL, now() - interval '40 days'),
('deal_008', 'acc_014', 'closed_won', 850000,   'anjali.mehta@mothi.com', now() - interval '4 days',   'cross_sell', 'in_app',         'AGS-GTM-20260320-005', now() - interval '30 days', now() - interval '28 days', now() - interval '26 days', now() - interval '26 days', now() - interval '24 days', now() - interval '18 days', now() - interval '12 days', 'expansion',    now() - interval '6 days',  NULL,                          NULL, now() - interval '30 days'),
-- Closed-lost (8)
('deal_009', 'acc_005', 'closed_lost', 5500000, 'priya.sharma@mothi.com', now() - interval '25 days',  'demand_gen', 'linkedin_inmail','AGS-GTM-20260301-001', now() - interval '110 days',now() - interval '105 days',now() - interval '100 days',now() - interval '100 days',now() - interval '95 days', now() - interval '80 days', now() - interval '60 days', 'new_business', NULL,                       now() - interval '30 days',     'Karza did 1-week POC; mothi-managed POC arrived too late',                       now() - interval '110 days'),
('deal_010', 'acc_018', 'closed_lost', 2100000, 'anjali.mehta@mothi.com', now() - interval '22 days',  'demand_gen', 'cold_email',     'AGS-GTM-20260305-002', now() - interval '85 days', now() - interval '82 days', now() - interval '78 days', now() - interval '78 days', now() - interval '72 days', now() - interval '55 days', now() - interval '40 days', 'new_business', NULL,                       now() - interval '25 days',     'Pricing — Razorpay quoted 0.05% lower MDR',                                          now() - interval '85 days'),
('deal_011', 'acc_037', 'closed_lost', 3800000, 'aditi.rao@mothi.com',    now() - interval '32 days',  'inbound',    'content_inbound',NULL,                  now() - interval '95 days', now() - interval '90 days', now() - interval '85 days', now() - interval '85 days', now() - interval '80 days', now() - interval '65 days', now() - interval '50 days', 'new_business', NULL,                       now() - interval '35 days',     'Capability gap — needed feature X, deferred to roadmap',                            now() - interval '95 days'),
('deal_012', 'acc_021', 'closed_lost', 1400000, 'vikram.singh@mothi.com', now() - interval '40 days',  'demand_gen', 'cold_email',     'AGS-GTM-20260305-002', now() - interval '75 days', now() - interval '70 days', now() - interval '67 days', now() - interval '67 days', now() - interval '62 days', now() - interval '50 days', NULL,                        'new_business', NULL,                       now() - interval '42 days',     'Timing — code freeze through Q3',                                                   now() - interval '75 days'),
-- Open deals (varying stages)
('deal_013', 'acc_001', 'poc',         9500000, 'priya.sharma@mothi.com', now() - interval '4 days',   'demand_gen', 'linkedin_inmail','AGS-GTM-20260301-001', now() - interval '60 days', now() - interval '55 days', now() - interval '50 days', now() - interval '50 days', now() - interval '45 days', now() - interval '30 days', now() - interval '15 days', 'new_business', NULL,                       NULL,                          NULL, now() - interval '60 days'),
('deal_014', 'acc_002', 'discovery',   8000000, 'rahul.kumar@mothi.com',  now() - interval '11 days',  'demand_gen', 'cold_email',     'AGS-GTM-20260301-001', now() - interval '40 days', now() - interval '37 days', now() - interval '34 days', now() - interval '34 days', now() - interval '30 days', now() - interval '20 days', NULL,                        'new_business', NULL,                       NULL,                          NULL, now() - interval '40 days'),
('deal_015', 'acc_013', 'demo',        7200000, 'anjali.mehta@mothi.com', now() - interval '5 days',   'demand_gen', 'linkedin_inmail','AGS-GTM-20260305-002', now() - interval '35 days', now() - interval '32 days', now() - interval '30 days', now() - interval '30 days', now() - interval '25 days', now() - interval '15 days', NULL,                        'new_business', NULL,                       NULL,                          NULL, now() - interval '35 days'),
('deal_016', 'acc_028', 'negotiation', 5500000, 'aditi.rao@mothi.com',    now() - interval '7 days',   'inbound',    'content_inbound',NULL,                  now() - interval '90 days', now() - interval '85 days', now() - interval '80 days', now() - interval '80 days', now() - interval '75 days', now() - interval '60 days', now() - interval '40 days', 'new_business', NULL,                       NULL,                          NULL, now() - interval '90 days'),
('deal_017', 'acc_030', 'proposal',    4200000, 'aditi.rao@mothi.com',    now() - interval '9 days',   'inbound',    'content_inbound',NULL,                  now() - interval '70 days', now() - interval '67 days', now() - interval '63 days', now() - interval '63 days', now() - interval '58 days', now() - interval '45 days', now() - interval '30 days', 'new_business', NULL,                       NULL,                          NULL, now() - interval '70 days'),
('deal_018', 'acc_041', 'qualification',12000000,'vikram.singh@mothi.com',now() - interval '6 days',   'partner',    'partner',        'AGS-GTM-20260325-006', now() - interval '25 days', now() - interval '22 days', now() - interval '20 days', now() - interval '20 days', now() - interval '16 days', NULL,                       NULL,                        'new_business', NULL,                       NULL,                          NULL, now() - interval '25 days'),
-- Recycled (3 — closed_lost but back in nurture, with one revival)
('deal_019', 'acc_022', 'closed_lost', 1900000, 'vikram.singh@mothi.com', now() - interval '180 days', 'demand_gen', 'cold_email',     'AGS-GTM-20260305-002', now() - interval '270 days',now() - interval '260 days',now() - interval '250 days',now() - interval '250 days',now() - interval '245 days',now() - interval '220 days',now() - interval '200 days', 'new_business', NULL,                       now() - interval '180 days',    'Pricing',                                                                            now() - interval '270 days'),
('deal_020', 'acc_022', 'discovery',   2500000, 'vikram.singh@mothi.com', now() - interval '15 days',  'demand_gen', 'webinar',        'AGS-GTM-20260410-009', now() - interval '30 days', now() - interval '28 days', now() - interval '25 days', now() - interval '25 days', now() - interval '18 days', NULL,                       NULL,                        'new_business', NULL,                       NULL,                          NULL, now() - interval '30 days')
ON CONFLICT (id) DO NOTHING;
...
('acc_001', 'cnt_001', 'deal_013', 'linkedin_inmail',    'impression', 'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '60 days', '{}'),
('acc_001', 'cnt_001', 'deal_013', 'linkedin_inmail',    'open',       'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '60 days', '{}'),
('acc_001', 'cnt_001', 'deal_013', 'linkedin_inmail',    'reply',      'human',              'AGS-GTM-20260301-001', now() - interval '58 days', '{"intent":"positive"}'),
('acc_001', 'cnt_001', 'deal_013', 'cold_email',         'open',       'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '55 days', '{}'),
('acc_001', 'cnt_001', 'deal_013', 'meeting',            'meeting',    'human',              'AGS-GTM-20260301-001', now() - interval '50 days', '{"duration_min":45}'),
('acc_001', 'cnt_001', 'deal_013', 'meeting',            'demo',       'human',              'AGS-GTM-20260301-001', now() - interval '45 days', '{"duration_min":60}'),
('acc_001', 'cnt_002', 'deal_013', 'meeting',            'meeting',    'human',              'AGS-GTM-20260301-001', now() - interval '30 days', '{"poc_kickoff":true}'),
('acc_001', 'cnt_001', 'deal_013', 'cold_email',         'reply',      'human',              'AGS-GTM-20260301-001', now() - interval '15 days', '{"intent":"objection","subcategory":"timing"}'),
-- Nykaa active deal (deal_015)
('acc_013', 'cnt_004', 'deal_015', 'linkedin_inmail',    'impression', 'outreach-writer', 'AGS-GTM-20260305-002', now() - interval '35 days', '{}'),
('acc_013', 'cnt_004', 'deal_015', 'linkedin_inmail',    'reply',      'human',              'AGS-GTM-20260305-002', now() - interval '33 days', '{"intent":"positive"}'),
('acc_013', 'cnt_004', 'deal_015', 'meeting',            'demo',       'human',              'AGS-GTM-20260305-002', now() - interval '15 days', '{"duration_min":60}'),
-- Closed-won deal_001 (Lendingkart) — full funnel
('acc_007', 'cnt_016', 'deal_001', 'cold_email',         'open',       'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '95 days', '{}'),
('acc_007', 'cnt_016', 'deal_001', 'cold_email',         'reply',      'human',              'AGS-GTM-20260301-001', now() - interval '90 days', '{}'),
('acc_007', 'cnt_016', 'deal_001', 'meeting',            'demo',       'human',              'AGS-GTM-20260301-001', now() - interval '70 days', '{}'),
('acc_007', 'cnt_016', 'deal_001', 'meeting',            'meeting',    'human',              'AGS-GTM-20260301-001', now() - interval '40 days', '{"contract_signed":true}'),
-- Closed-won expansion deal_007 (Lendingkart cross-sell)
('acc_007', 'cnt_016', 'deal_007', 'csm_outreach',       'reply',      'human',              'AGS-GTM-20260315-004', now() - interval '40 days', '{"cross_sell":"mobile360"}'),
('acc_007', 'cnt_016', 'deal_007', 'meeting',            'demo',       'human',              'AGS-GTM-20260315-004', now() - interval '25 days', '{}'),
-- D2C campaign mass touches (acc_014, 015, 023 etc)
('acc_014', 'cnt_006', 'deal_002', 'cold_email',         'impression', 'outreach-writer', 'AGS-GTM-20260305-002', now() - interval '70 days', '{}'),
('acc_014', 'cnt_006', 'deal_002', 'cold_email',         'open',       'outreach-writer', 'AGS-GTM-20260305-002', now() - interval '70 days', '{}'),
('acc_014', 'cnt_006', 'deal_002', 'cold_email',         'click',      'outreach-writer', 'AGS-GTM-20260305-002', now() - interval '69 days', '{}'),
('acc_014', 'cnt_006', 'deal_002', 'cold_email',         'reply',      'human',              'AGS-GTM-20260305-002', now() - interval '67 days', '{"intent":"positive"}'),
('acc_014', 'cnt_006', 'deal_002', 'meeting',            'demo',       'human',              'AGS-GTM-20260305-002', now() - interval '40 days', '{}'),
-- Many short impression-only touches across the rest (cold outbound at scale)
('acc_004', 'cnt_015', NULL,        'linkedin_inmail',    'impression', 'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '40 days', '{}'),
('acc_006', NULL,       NULL,        'cold_email',         'impression', 'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '38 days', '{}'),
('acc_009', NULL,       NULL,        'cold_email',         'impression', 'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '36 days', '{}'),
('acc_008', NULL,       NULL,        'cold_email',         'impression', 'outreach-writer', 'AGS-GTM-20260301-001', now() - interval '34 days', '{}'),
('acc_021', NULL,       NULL,        'cold_email',         'impression', 'outreach-writer', 'AGS-GTM-20260305-002', now() - interval '32 days', '{}'),
('acc_022', NULL,       NULL,        'cold_email',         'impression', 'outreach-writer', 'AGS-GTM-20260305-002', now() - interval '30 days', '{}'),
('acc_046', NULL,       NULL,        'partner',            'meeting',    'human',              'AGS-GTM-20260325-006', now() - interval '20 days', '{}'),
('acc_044', NULL,       NULL,        'wtfraud_community',  'reply',      'human',              'AGS-GTM-20260410-009', now() - interval '11 days', '{}'),
-- Recycled account revival touches
('acc_022', NULL,       'deal_020', 'webinar',            'meeting',    'human',              'AGS-GTM-20260410-009', now() - interval '20 days', '{"webinar_id":"wtfraud_q2"}'),
('acc_022', NULL,       'deal_020', 'cold_email',         'reply',      'human',              'AGS-GTM-20260410-009', now() - interval '15 days', '{}');
...
('tx_001', 'fathom', 'deal_013', now() - interval '50 days', 2700, 'Anita Sharma (HDFC): The issue isn''t capability — your Mobile360 numbers look better than Karza''s. The issue is, we''re in the middle of a 3-month security audit and any new vendor onboarding is paused until July. Also, Karza did a 1-week POC for us last year — they were faster on that. Can you match that turnaround? Mothi: Yes, we can offer a mothi-managed POC where our SE runs your file and delivers a benchmark deck in 5 days. Anita: OK, send it. Loop in Rohan our Onboarding Lead.', '{"attendees":["anita.sharma@hdfcbank.com","mothi@mothi.com"]}'),
('tx_002', 'fathom', 'deal_015', now() - interval '15 days', 3600, 'Rohan Malhotra (Nykaa): Honestly the MDR delta is small — 0.05% versus Razorpay. Where I see the win is cross-border. We just launched UAE shipping last month and our current FX cost is killing us. Mothi: mothi International PG settles in INR sub-2% MDR with FX hedging. Rohan: Send me the spec.', '{"attendees":["rohan.malhotra@nykaa.com","anjali.mehta@mothi.com"]}'),
('tx_003', 'fathom', 'deal_001', now() - interval '70 days', 4200, 'Harshvardhan Lunia (Lendingkart): Mobile360 NTC coverage is exactly what we need — bureau prefill misses 60% of our applicants. Let''s run the POC. mothi SE: We''ll have benchmarks ready in 5 business days.', '{"attendees":["harshvardhan.lunia@lendingkart.com","priya.sharma@mothi.com"]}'),
('tx_004', 'fathom', 'deal_009', now() - interval '40 days', 3000, 'Deal lost call. Tata Capital prospect: Karza''s 1-week POC turnaround beat us by 3 weeks. They''ve already started integration. mothi-managed POC offering came too late — we should have led with it.', '{"outcome":"lost","reason":"poc_timing"}'),
...
('tx_007', 'fathom', 'deal_004', now() - interval '30 days', 3300, 'Hiver call. Customer (CFO): Need recurring billing for SaaS subscription. AutoPay coverage on UPI is non-negotiable. mothi pitched UPI AutoPay deepest coverage in India. Customer: Move to proposal.', '{}'),
...
-- HDFC (acc_001)
('acc_001', 'deal_013', 'objection_raised',     'security audit pause until July',           'transcript', 'tx_001', 0.95, 'drive-transcript-extractor'),
('acc_001', 'deal_013', 'competitor_mentioned', 'Karza — 1-week POC turnaround',             'transcript', 'tx_001', 0.98, 'drive-transcript-extractor'),
('acc_001', 'deal_013', 'next_step_committed',  'Send mothi-managed POC spec',            'transcript', 'tx_001', 0.94, 'drive-transcript-extractor'),
('acc_001', 'deal_013', 'decision_maker_added', 'Rohan — Onboarding Lead',                   'transcript', 'tx_001', 0.91, 'drive-transcript-extractor'),
-- Nykaa (acc_013)
('acc_013', 'deal_015', 'expansion_signal',     'international shipping launched (UAE)',     'transcript', 'tx_002', 0.92, 'drive-transcript-extractor'),
('acc_013', 'deal_015', 'competitor_mentioned', 'Razorpay — 0.05% MDR delta',                'transcript', 'tx_002', 0.96, 'drive-transcript-extractor'),
-- Tata Capital lost (acc_005)
('acc_005', 'deal_009', 'churn_risk_phrase',    'Karza already started integration',         'transcript', 'tx_004', 0.93, 'drive-transcript-extractor'),
-- Sugar lost (acc_018)
('acc_018', 'deal_010', 'objection_raised',     'pricing — Razorpay 0.05% lower',            'transcript', 'tx_005', 0.92, 'drive-transcript-extractor'),
-- Lendingkart cross-sell (acc_007)
('acc_007', 'deal_007', 'expansion_signal',     '80+ manual influencer payments/month',      'transcript', 'tx_006', 0.94, 'drive-transcript-extractor'),
-- Hiver (acc_034)
('acc_034', 'deal_004', 'expansion_signal',     'recurring billing requirement',             'transcript', 'tx_007', 0.91, 'drive-transcript-extractor'),
-- Swiggy (acc_041)
('acc_041', 'deal_018', 'expansion_signal',     'vendor count crossed 200K',                 'transcript', 'tx_008', 0.95, 'drive-transcript-extractor'),
('acc_041', 'deal_018', 'next_step_committed',  'integration spec in 2 weeks; Q3 migration', 'transcript', 'tx_008', 0.93, 'drive-transcript-extractor');
...
('mothiteam.io',  'tier_c_outbound', now() - interval '180 days', 100, 'healthy'),
('mothiteam.com', 'tier_c_outbound', now() - interval '160 days', 100, 'healthy'),
('mothi-india.io','tier_c_outbound', now() - interval '140 days', 100, 'healthy'),
('mothi-pay.io',  'tier_c_outbound', now() - interval '120 days', 80,  'warning'),
('cfteam.in',        'tier_c_outbound', now() - interval '90 days',  60,  'healthy'),
('cfreach.io',       'tier_c_outbound', now() - interval '60 days',  50,  'healthy'),
('grow.mothi.com','pmm_demand',      now() - interval '300 days', 200, 'healthy'),
('hello.mothi.com','mothi_warmed',now() - interval '500 days', 200, 'healthy'),
('mothi-team.in', 'reserve',         now() - interval '20 days',  30,  'healthy'),
('mothi-co.io',   'reserve',         NULL,                          0,  'healthy')
...
('calendar_fill_pct',          'mart_ae_performance',     'calendar_fill_pct_4wk_avg',  'avg',  'AE calendar fill rate (% of capacity hours booked, Mon-Fri only). North-star metric.', 'revops@mothi.com', '{sheets,metabase,quicksight}'),
('pipeline_created_inr',       'mart_buyer_journey',      'opportunity_amount',         'sum',  'Total open pipeline ₹ from new opportunities.',                                       'revops@mothi.com', '{sheets,metabase,quicksight}'),
('mql_to_sql_pct',             'mart_buyer_journey',      'sql_date',                   'rate', '% of MQLs that became SQLs.',                                                          'revops@mothi.com', '{metabase,quicksight}'),
('sql_to_won_pct',             'mart_buyer_journey',      'closed_won_date',            'rate', '% of SQLs that became Closed-Won.',                                                    'revops@mothi.com', '{metabase,quicksight}'),
('cost_per_demo_inr',          'mart_din_performance',    'cost_per_demo_inr',          'avg',  '₹ spent per demo booked (per DIN). Anti-sprawl checked.',                              'revops@mothi.com', '{metabase}'),
('reply_rate_pct',             'mart_outbound_health',    'reply_rate_pct_30d',         'avg',  'Reply rate per sender domain over last 30 days.',                                      'mops@mothi.com',   '{sheets,metabase}'),
('onboarding_completion_pct',  'mart_lifecycle_metrics',  'this_week_pct',              'rate', '% new merchants who activated within 30d of signup. Razorpay floor: 29%.',             'cs@mothi.com',     '{sheets,metabase,quicksight}'),
('retention_pct',              'mart_lifecycle_metrics',  'this_week_pct',              'rate', '% activated merchants still active (last touch <90d). Razorpay floor: 25%.',            'cs@mothi.com',     '{sheets,metabase,quicksight}'),
('reengagement_pct',           'mart_lifecycle_metrics',  'this_week_pct',              'rate', '% dormant accounts that reengaged within 60d. Razorpay floor: 19%.',                   'cs@mothi.com',     '{sheets,metabase,quicksight}'),
('adoption_pct',               'mart_lifecycle_metrics',  'this_week_pct',              'rate', '% feature adoptions tied to a campaign. Razorpay floor: 16%.',                          'pmm@mothi.com',    '{sheets,metabase,quicksight}'),
('account_health_score',       'mart_account_health',     'churn_risk_score',           'avg',  'Composite per-account churn risk (0-5).',                                              'cs@mothi.com',     '{metabase,quicksight}'),
('din_roi_multiple',           'mart_din_performance',    'roi_multiple',               'avg',  'Won revenue / spend per DIN.',                                                         'revops@mothi.com', '{metabase,quicksight}')
