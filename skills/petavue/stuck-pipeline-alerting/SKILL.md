...
## Tooling
- Petavue MCP, Salesforce (with stage history enabled), Clari, Gong, Outreach for follow-up

## Source
[Petavue — Stuck Pipeline Alerting](https://www.petavue.com/resources/prompts) — RevOps / Sales
