...
| Tool | Use |
|------|-----|
| Petavue MCP | Primary execution; pulls cross-source data |
...
Adapted from [Petavue's GTM Prompt Library — Asset Engagement Analysis](https://www.petavue.com/resources/prompts).
